...
-(BOOL)hasSavedLauncherItems {
    return NO;//([self retrieveFromUserDefaults:@"myLauncherView"] != nil);
}
...
//	UIViewController *controller = [[viewCtrClass alloc] init]; //shahil
    AccountViewController *controller = (AccountViewController*)[[viewCtrClass alloc] initWithStyle:UITableViewStyleGrouped];
    controller.addToFavorite = NO;
	controller.buddyID = [item controllerTitle];
